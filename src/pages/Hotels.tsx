  ...
  return (
    <div className="min-h-screen bg-slate-50 pb-20">
      ...
      <div className="max-w-7xl mx-auto px-4 -mt-16 md:-mt-24 relative z-20">
        <FlightSearch initialTab="Hotels" />
      </div>

      {/* Featured Hotels Section (Optional but adds value) */}
      <section className="max-w-7xl mx-auto px-4 mt-20 md:mt-24">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {[
            ...
            <div key={hotel.id} className="bg-white rounded-[2rem] overflow-hidden shadow-xl hover:shadow-2xl transition-all border border-slate-100 group">
              ...
              <div className="p-6 md:p-8">
                ...
                <p className="text-slate-500 flex items-center text-sm font-medium">
                  <span className="w-1.5 h-1.5 bg-accent rounded-full mr-2" />
                  {hotel.location}
                </p>
                <button className="mt-6 w-full py-3 md:py-4 bg-slate-50 hover:bg-primary hover:text-white text-primary font-bold rounded-xl transition-all border border-slate-100 hover:border-primary">
