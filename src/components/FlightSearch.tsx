        ...
        {activeTab === 'Flights' && (
          <form onSubmit={handleSearch} className={cn("space-y-6", compact && "space-y-4")}>
            ...
            <div className="flex justify-center pt-4">
              <button
                type="submit"
                className="bg-primary hover:bg-secondary text-white px-12 py-4 rounded-xl font-bold text-lg shadow-lg shadow-primary/20 transition-all hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center space-x-3 w-full sm:w-auto"
              >
